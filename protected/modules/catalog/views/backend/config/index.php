...
<?php $form = $this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->radioButtonList($model,'resize_mode', array(
            '1'=>'Пропорционально вписать в заданный размер',
            '2'=>'Пропорционально вписать в заданный размер и дополнить белым полем',
        )); ?>
